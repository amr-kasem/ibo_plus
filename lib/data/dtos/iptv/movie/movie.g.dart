...
Map<String, dynamic> _$$MovieJsonModelImplToJson(
    ...
    <String, dynamic>{
      ...
      'rating':
          const StringToNullableDoubleSerializer().toJson(instance.rating),
      'rating5_based': instance.rating5Based,
      'added': instance.added,
      'category_id':
          const StringToNullableIntSerializer().toJson(instance.categoryId),
      'container_extension': instance.containerExtension,
      'custom_sid':
          const StringToNullableIntSerializer().toJson(instance.customSid),
    };
