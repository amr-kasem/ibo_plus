...
mixin _$MovieJsonModel {
  ...
  @StringToNullableDoubleConverter()
...
class _$MovieJsonModelImpl implements _MovieJsonModel {
  const _$MovieJsonModelImpl(
      ...
      this.streamIcon,
      @StringToNullableDoubleConverter() this.rating,
      this.rating5Based,
      this.added,
      @StringToNullableIntConverter() this.categoryId,
      this.containerExtension = "mp4",
      @StringToNullableIntConverter() this.customSid});
...
abstract class _MovieJsonModel implements MovieJsonModel {
  const factory _MovieJsonModel(
          ...
          final String? streamIcon,
          @StringToNullableDoubleConverter() final double? rating,
          final double? rating5Based,
          final String? added,
          @StringToNullableIntConverter() final int? categoryId,
          final String? containerExtension,
          @StringToNullableIntConverter() final int? customSid}) =
