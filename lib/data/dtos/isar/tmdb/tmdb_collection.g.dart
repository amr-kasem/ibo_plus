...
extension GetTmdbCollectionIsarModelCollection on Isar {
  IsarCollection<TmdbCollectionIsarModel> get tmdbCollectionIsarModels =>
      this.collection();
}

const TmdbCollectionIsarModelSchema = CollectionSchema(
  name: r'TmdbCollectionIsarModel',
  id: -1491517731984176181,
  properties: {
  ...
  estimateSize: _tmdbCollectionIsarModelEstimateSize,
  serialize: _tmdbCollectionIsarModelSerialize,
  deserialize: _tmdbCollectionIsarModelDeserialize,
  deserializeProp: _tmdbCollectionIsarModelDeserializeProp,
  idName: r'id',
  indexes: {},
  links: {
    r'movies': LinkSchema(
      id: 8096626884721608068,
      name: r'movies',
  ...
  embeddedSchemas: {},
  getId: _tmdbCollectionIsarModelGetId,
  getLinks: _tmdbCollectionIsarModelGetLinks,
  attach: _tmdbCollectionIsarModelAttach,
  version: '3.1.0+1',
);

int _tmdbCollectionIsarModelEstimateSize(
  TmdbCollectionIsarModel object,
  List<int> offsets,
...
void _tmdbCollectionIsarModelSerialize(
  TmdbCollectionIsarModel object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
TmdbCollectionIsarModel _tmdbCollectionIsarModelDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = TmdbCollectionIsarModel(
...
P _tmdbCollectionIsarModelDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _tmdbCollectionIsarModelGetId(TmdbCollectionIsarModel object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _tmdbCollectionIsarModelGetLinks(
    TmdbCollectionIsarModel object) {
  return [object.movies];
}

void _tmdbCollectionIsarModelAttach(
    IsarCollection<dynamic> col, Id id, TmdbCollectionIsarModel object) {
  object.movies.attach(
      col, col.isar.collection<MovieDetailsTmdbIsarModel>(), r'movies', id);
}

extension TmdbCollectionIsarModelQueryWhereSort
    on QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QWhere> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QAfterWhere>
      anyId() {
...
extension TmdbCollectionIsarModelQueryWhere on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QWhereClause> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel,
...
extension TmdbCollectionIsarModelQueryFilter on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QFilterCondition> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel,
...
extension TmdbCollectionIsarModelQueryObject on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QFilterCondition> {}

extension TmdbCollectionIsarModelQueryLinks on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QFilterCondition> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel,
...
extension TmdbCollectionIsarModelQuerySortBy
    on QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QSortBy> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QAfterSortBy>
      sortByBackdropPath() {
    return QueryBuilder.apply(this, (query) {
...
extension TmdbCollectionIsarModelQuerySortThenBy on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QSortThenBy> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QAfterSortBy>
      thenByBackdropPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backdropPath', Sort.asc);
...
extension TmdbCollectionIsarModelQueryWhereDistinct on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QDistinct> {
  QueryBuilder<TmdbCollectionIsarModel, TmdbCollectionIsarModel, QDistinct>
...
extension TmdbCollectionIsarModelQueryProperty on QueryBuilder<
    TmdbCollectionIsarModel, TmdbCollectionIsarModel, QQueryProperty> {
  QueryBuilder<TmdbCollectionIsarModel, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<TmdbCollectionIsarModel, String, QQueryOperations>
