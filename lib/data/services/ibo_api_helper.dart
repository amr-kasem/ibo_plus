...
class IboApiHelper {
  String getEncryptKey(int length) {
    const symbols =
  ...
  int getEncryptKeyPosition(String character) {
    const symbols =
        'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890';
  ...
  String getEncryptPositionChar(int position) {
    const symbols =
        'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890';
    return symbols[position];
  }

  String encryptRequest(dynamic data) {
  ...
  dynamic decryptResponse(String data1) {
