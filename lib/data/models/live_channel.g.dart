...
void _liveChannelSerialize(
  ...
  writer.writeString(offsets[15], object.tvArchiveDuration);
}
...
LiveChannel _liveChannelDeserialize(
  ...
  final object = LiveChannel(
    ...
    tvArchiveDuration: reader.readStringOrNull(offsets[15]),
  );
...
LiveChannel _$LiveChannelFromJson(Map<String, dynamic> json) => LiveChannel(
      ...
      tvArchiveDuration: AppUtils.toStr(json['tv_archive_duration']),
      epgListings: (json['epg_listings'] as List<dynamic>?)
          ?.map((e) => EPG.fromJson(e as Map<String, dynamic>))
          .toList(),
      isAdult: AppUtils.intToNullableBool((json['is_adult'] as num?)?.toInt()),
    );
...
Map<String, dynamic> _$LiveChannelToJson(LiveChannel instance) =>
    <String, dynamic>{
      ...
      'is_adult': AppUtils.boolToNullableInt(instance.isAdult),
    };
