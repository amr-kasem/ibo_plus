...
abstract class $LiveChannelJsonModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      int? tvArchive,
      String? directSource,
      @DynamicToStringConverter() String? tvArchiveDuration,
      List<EPGJsonModel>? epgListings,
      @NullableIntToBoolConverter() bool? isAdult});
}
...
class _$LiveChannelJsonModelImpl implements _LiveChannelJsonModel {
  const _$LiveChannelJsonModelImpl(
      ...
      this.tvArchive,
      this.directSource,
      @DynamicToStringConverter() this.tvArchiveDuration,
      final List<EPGJsonModel>? epgListings,
      @NullableIntToBoolConverter() this.isAdult})
...
abstract class _LiveChannelJsonModel implements LiveChannelJsonModel {
  const factory _LiveChannelJsonModel(
          ...
          final int? tvArchive,
          final String? directSource,
          @DynamicToStringConverter() final String? tvArchiveDuration,
          final List<EPGJsonModel>? epgListings,
          @NullableIntToBoolConverter() final bool? isAdult}) =
